...
// CUT begin
	public static void main(String[] args){
		System.err.println("FallingSand (250 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1437730606;
	...
	static class Reader {
        private static final String dataFileName = "FallingSand.sample";
