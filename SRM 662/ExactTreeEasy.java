...
// CUT begin
	public static void main(String[] args){
		System.err.println("ExactTreeEasy (500 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1437728393;
	...
	static class Reader {
        private static final String dataFileName = "ExactTreeEasy.sample";
