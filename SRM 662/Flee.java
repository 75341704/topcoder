...
// CUT begin
	public static void main(String[] args){
		System.err.println("Flee (1000 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1437724870;
	...
	static boolean doTest(int[] x, int[] y, double __expected) {
		long startTime = System.currentTimeMillis();
		Throwable exception = null;
		Flee instance = new Flee();
		double __result = 0.0;
		try {
			__result = instance.maximalSafetyLevel(x, y);
		}
	...
	static class Reader {
        private static final String dataFileName = "Flee.sample";
